...
export default function PrivacyPolicy() {
  return (
    <div className="content">
      ...
      <Paragraph>
        This Privacy Policy governs the manner in which this website collects,
        uses, maintains, and discloses information collected from users (each, a
        &quotUser&quot) of the https://prp-nine.vercel.app/ website (&quotSite&quot).
      </Paragraph>
      ...
      <Paragraph>
        ...
        a form, subscribe to the newsletter, respond to a survey, and in
      ...
      <Paragraph>
        ...
        technical information about Users&apos means of connection to our Site, such
      ...
      <Paragraph>
        Our Site may use &quotcookies&quot to enhance the User experience. User&aposs web
      ...
      <Paragraph>
        Our Site may collect and use Users&apos personal information for the
        following purposes:
      </Paragraph>
      <ul>
      ...
      <Paragraph>
        We do not sell, trade, or rent Users&apos personal identification
      ...
      <Paragraph>
        We has the discretion to update this privacy policy at any time. When we
